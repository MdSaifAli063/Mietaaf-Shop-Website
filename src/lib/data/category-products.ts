...
export const CATEGORY_PRODUCTS: Record<CategorySlug, readonly EditableCategoryProduct[]> = {
  sherwani: [
    product(1, "Royal Embroidered Sherwani", "https://ik.imagekit.io/c5zhitarg/image_ebd76a09.png?updatedAt=1784387675301", 45999, 52999, 13, 4.9, 128, "Silk blend with zari accents and breathable cotton lining."),
    product(2, "Ivory Palace Sherwani", "https://ik.imagekit.io/c5zhitarg/image_1811519d.png?updatedAt=1784387632919", 36999, 42899, 14, 4.7, 18, "Ivory silk blend with tonal threadwork and soft lining."),
    product(3, "Emerald Heritage Sherwani", "https://ik.imagekit.io/c5zhitarg/WhatsApp%20Image%202026-07-16%20at%2011.36.02%20AM%20(2).jpeg?updatedAt=1784303238199", 40199, 46599, 14, 4.8, 29, "Emerald raw silk base with zari highlighting and structured lining."),
    product(4, "Champagne Zari Sherwani", "https://ik.imagekit.io/c5zhitarg/WhatsApp%20Image%202026-07-17%20at%209.57.54%20PM.jpeg?updatedAt=1784306208099", 43399, 50299, 14, 4.9, 40, "Champagne silk-brocade with subtle gold zari detailing."),
  ...
  blazer: [
    product(1, "Midnight Architect Blazer", "https://ik.imagekit.io/c5zhitarg/WhatsApp%20Image%202026-07-16%20at%2011.36.02%20AM.jpeg?updatedAt=1784303257661", 12999, 14999, 13, 4.7, 86, "Italian wool blend with clean lapel structure and satin lining."),
    product(2, "Midnight Peak Blazer", "/categories/premium-collection.webp", 11999, 13999, 14, 4.6, 18, "Premium wool blend with sharp peak lapel and soft drape."),
    product(3, "Charcoal Atelier Blazer", "", 13799, 15999, 14, 4.7, 29, "Charcoal textured wool blend with structured shoulder line."),
    product(4, "Emerald Evening Blazer", "/hero/premium-suits.webp", 15599, 18099, 14, 4.8, 40, "Emerald suiting fabric with tonal weave and refined finish."),
  ...
  coat: [
    product(1, "Cashmere Overcoat", "/categories/coat.webp", 24999, 28999, 14, 4.8, 54, "Wool-cashmere blend with satin-lined sleeves and soft warmth."),
    product(2, "Structured Trench Coat", "/categories/blazer.webp", 17999, 20899, 14, 4.6, 38, "Wool-rich trench fabric with sharp drape and clean finish."),
    product(3, "Camel Regent Overcoat", "/categories/premium-collection.webp", 17999, 20899, 14, 4.7, 29, "Camel wool blend with polished outerwear structure."),
    product(4, "Midnight Wool Topcoat", "/categories/suits.webp", 20099, 23299, 14, 4.8, 40, "Midnight wool topcoat fabric with smooth layered construction."),
  ...
  kurta: [
    product(1, "Silk Festive Kurta Set", "https://ik.imagekit.io/c5zhitarg/image_11b3b7cd.png", 8999, 10499, 14, 4.6, 210, "Matka silk blend with breathable lining and festive drape."),
    product(2, "Minimal Linen Kurta", "https://ik.imagekit.io/c5zhitarg/image_3989acf6.png?updatedAt=1784387591694", 4999, 5799, 14, 4.5, 72, "European linen with airy structure and clean tailoring."),
    ...
    product(4, "Ivory Silk Kurta Set", "https://ik.imagekit.io/c5zhitarg/image_229411d4%20(1).png?updatedAt=1784387614171", 6899, 7999, 14, 4.8, 40, "Ivory silk blend with premium hand-finished sheen."),
  ...
  pants: [
    product(1, "Pleated Tuxedo Trousers", "/categories/pants.webp", 4999, 5799, 14, 4.5, 67, "Wool barathea with satin stripe and clean pleat structure."),
    product(2, "Black Satin-Stripe Trousers", "/categories/suits.webp", 4499, 5199, 14, 4.6, 18, "Black satin-striped suiting with smooth formal finish."),
    product(3, "Charcoal Tailored Trousers", "/categories/blazer.webp", 5149, 5999, 14, 4.7, 29, "Charcoal wool-blend trouser with crisp, tailored line."),
    product(4, "Navy Pleated Trousers", "/categories/premium-collection.webp", 5799, 6699, 14, 4.8, 40, "Navy wool blend with a soft drape and elegant pleat."),
  ...
  "indo-western": [
    product(1, "Indo-Western Bandhgala", "https://ik.imagekit.io/c5zhitarg/WhatsApp%20Image%202026-07-17%20at%209.57.55%20PM.jpeg?updatedAt=1784303275123", 13999, 16299, 14, 4.7, 93, "Linen-wool blend with lightweight structure and sharp collar."),
    product(2, "Monochrome Indo Set", "/categories/indo-western.webp", 16999, 19799, 14, 4.6, 33, "Monochrome fusion fabric with clean, modern drape."),
    product(3, "Teal Architectural Indo-Western", "/categories/festive-collection.webp", 14999, 17399, 14, 4.7, 29, "Teal wool-silk blend with architectural tailoring."),
    product(4, "Onyx Draped Indo-Western Set", "/categories/wedding-collection.webp", 16899, 19699, 14, 4.8, 40, "Onyx draped suiting with subtle sheen and contouring."),
