...
export const CATEGORY_PRODUCTS: Record<CategorySlug, readonly EditableCategoryProduct[]> = {
  ...
  suits: [
    product(1, "Emerald Royale Tuxedo Set", "/catalog-photos/catalog-page-01.webp", 14999, 17999, 15, 4.9, 48, "Premium textured suiting with refined sheen and tailored construction."),
    product(2, "Midnight Gold Velvet Tuxedo Set", "/catalog-photos/catalog-page-02.webp", 18999, 22999, 13, 4.8, 37, "Midnight velvet-touch suiting with luxe gold-thread finish."),
    product(3, "Ivory Royale Suit Set", "/catalog-photos/catalog-page-03.webp", 16999, 19999, 14, 4.7, 31, "Ivory premium suiting with tonal finish and smooth drape."),
    product(4, "Royal Amethyst Bandhgala Set", "/catalog-photos/catalog-page-04.webp", 21999, 24999, 15, 4.8, 28, "Royal amethyst suiting with rich texture and embroidery accents."),
    product(5, "Noir Panther Suit Set", "/catalog-photos/catalog-page-05.webp", 15999, 19999, 14, 4.9, 42, "Noir premium suiting with tonal sheen and polished lapel details."),
    product(6, "Burgundy Beaded Tuxedo Set", "/catalog-photos/catalog-page-06.webp", 18999, 21999, 14, 4.8, 34, "Burgundy textured suiting with beadwork accents and soft lining."),
    product(7, "Peacock Heritage Bandhgala Set", "/catalog-photos/catalog-page-07.webp", 21999, 24999, 15, 4.7, 26, "Peacock heritage suiting with hand-finished zari detailing."),
    product(8, "Cognac Heritage Three-Piece Tuxedo", "/catalog-photos/catalog-page-08.webp", 13999, 16999, 14, 4.9, 39, "Cognac premium textured suiting with structured three-piece profile."),
  ],
  kurta: [
  ...
  "festive-collection": [
    product(1, "Silk Brocade Festive Bandhgala", "https://ik.imagekit.io/c5zhitarg/WhatsApp%20Image%202026-07-17%20at%209.57.52%20PM.jpeg?updatedAt=1784306175798", 9999, 11999, 14, 4.8, 61, "Silk brocade with jacquard texture and festive sheen."),
