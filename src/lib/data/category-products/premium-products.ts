...
export const PREMIUM_PRODUCTS: readonly EditableCategoryProduct[] = [
  ...
  product(5, "Premium Suit", "https://ik.imagekit.io/c5zhitarg/3-pcs-premium-suit-in-blue-cyprus-blackberrys-clothing-3.jpg_v=1685955692", 17999, 19999, 13, 4.9, 21, "Luxury wool-silk blend with full-canvas construction and high-end drape."),
